...
/** Sweeping color ribbons behind an animated headline + badges. Reads props live. */
export function ribbon(props: ReadonlySignal<Record<string, unknown>>): Composition {
  const p = () => props.get() as Partial<RibbonProps>;
