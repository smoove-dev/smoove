...
/**
 * Highlight showcase — a marker inside a `Block`, several marks at once, and a
 * long (multi-line) mark next to a short one. Each mark splits at line breaks
 * without rounding or padding the broken edge.
 */
