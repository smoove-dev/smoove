...
/**
 * Typewriter showcase — inside a `Block` bubble, a reveal-then-highlight combo,
 * and a side-by-side of `reserveHeight: true` vs `false`.
 */
export const textTypewriterDemo: DemoDef = {
  ...
  build(container) {
    ...
    const PARA =
      "This text reveals line by line. Watch the caption beneath it as more lines appear.";
