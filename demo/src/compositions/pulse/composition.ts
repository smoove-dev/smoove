...
import type { PulseProps } from "./schema.js";
...
/** A row of pulsing circles + a title — reads its `props` signal live; a player
    or the studio drives edits with `comp.setProps`. */
const comp = new Composition<PulseProps>({
  id: "pulse",
  fps: FPS,
  durationInFrames: FRAMES,
  width: WIDTH,
  height: HEIGHT,
  props: { title: "Pulse", accent: "#7c5cff", count: 6, size: 60 },
});
