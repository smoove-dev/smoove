...
export type QuattrocentoSansOptions = GoogleFontOptions<
  QuattrocentoSansWeight,
  QuattrocentoSansStyle,
  QuattrocentoSansSubset
>;
 ...
 */
export default class QuattrocentoSans extends GoogleFont<
  QuattrocentoSansWeight,
  QuattrocentoSansStyle,
  QuattrocentoSansSubset
> {
