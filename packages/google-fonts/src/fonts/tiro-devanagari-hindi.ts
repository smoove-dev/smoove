...
export type TiroDevanagariHindiOptions = GoogleFontOptions<
  TiroDevanagariHindiWeight,
  TiroDevanagariHindiStyle,
  TiroDevanagariHindiSubset
>;
 ...
 */
export default class TiroDevanagariHindi extends GoogleFont<
  TiroDevanagariHindiWeight,
  TiroDevanagariHindiStyle,
  TiroDevanagariHindiSubset
> {
