// Derived from paper-design/shaders packages/shaders/src/shaders/mesh-gradient.ts (Apache-2.0). See NOTICE.
// Adaptations: sizing system removed (plain v_uv), helper chunks inlined,
// dynamic `break` rewritten to an `if` guard for GLSL ES 1.00.
