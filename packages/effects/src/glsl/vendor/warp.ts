// Derived from paper-design/shaders packages/shaders/src/shaders/warp.ts (Apache-2.0). See NOTICE.
...
float randomG(vec2 p) {
  vec2 uv = fract(floor(p) / 100. + .5);
  uv = fract(uv * vec2(0.3183099, 0.3678794)) + 0.1;
  uv += dot(uv, uv + 19.19);
