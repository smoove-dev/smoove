...
import orbit from '../../src/demos/orbit.ts?url&no-inline';
import orbitSource from '../../src/demos/orbit.ts?raw';

<Demo src={orbit} source={orbitSource} lang="ts" label="loaded via src" />
